...
*/
+ (NSTimer * _Nonnull)runThisEveryWithSeconds:(NSTimeInterval)seconds handler:(void (^ _Nonnull)(NSTimer * _Nullable))handler;
/**
...
/**
  ...
  ⚠️ You also need to implement \code
  keyboardWillShowNotification(_ notification: Notification)
  \endcode
*/
...
/**
  ...
  ⚠️ You also need to implement \code
  keyboardDidShowNotification(_ notification: Notification)
  \endcode
*/
...
/**
  ...
  ⚠️ You also need to implement \code
  keyboardWillHideNotification(_ notification: Notification)
  \endcode
*/
...
/**
  ...
  ⚠️ You also need to implement \code
  keyboardDidHideNotification(_ notification: Notification)
  \endcode
*/
